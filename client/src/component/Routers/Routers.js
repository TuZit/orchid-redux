...
function Routers({ productItems, cartItems }) {
  return (
    <div id="routers">
      <Routes>
        <Route
        ...
        <Route
          path="/shop"
          element={<Shop productItems={productItems} cartItems={cartItems} />}
        />
        ...
        <Route
          path="/cart"
          element={
            <CartPage productItems={productItems} cartItems={cartItems} />
          }
        />
        <Route
          path="/about"
          element={<ShopPage productItems={productItems} />}
        />
        ...
        <Route path="/manage" element={<UserManage />} />
        <Route path="/pagi" element={<Pagi productItems={productItems} />} />
        <Route
          path="/details/:id"
